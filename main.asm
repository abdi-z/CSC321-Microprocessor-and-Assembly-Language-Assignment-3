.model small
.stack 100h                       ;this directive will reserve a memory block of 100h for stack
.data
...
crudProgS db 'A C.R.U.D Project "A Food Ordering Management System"$'
creditsProgS db 'By Abdul Rehman Aziz, M.Daniyal Javed, M.Ahmed Raza$'
nameArr db 20 dup('$') 
str1 db 'What is your good name, dear customer:$' 
str2 db 13,10, 'string op is:$'
thanku db 13,2,'Thank you for coming, $',
simpleLinUp db ' ________________________________$'
simpleLinDw db ' --------------------------------$'                                   
presShS db  '| Enter 1 to order a Shwarma(150)|$'
presPizS db '| Enter 2 to order a Pizza(250)  |$'
presBurS db '| Enter 3 to order a Burger(350) |$'
presSamS db '| Enter 4 to order a Samosa(100) |$'
...
noOfS dw '0'    ;variable to keep track of how many shwarmas ordered
noOfP db '0'    ;...pizza
noOfB db '0'    ;...burger
noOfSm db '0'
.code
